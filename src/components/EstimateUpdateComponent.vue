  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <v-textarea class="form-control" v-model="getEstimateUpdate.content" />
        </div>
      </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          ...
          <div class="d-flex flex-wrap mt-3">
            <div
              v-for="(url, index) in getEstimateUpdate.image_urls"
              :key="index"
      ...
      <div class="mb-3 row mt-4">
        <div class="col-6 d-grid p-1">
          <button type="button" class="btn btn-lg btn-dark" @click="goToDetail(getEstimateUpdate.board_id)">
            취소하기
          </button>
        </div>
        <div class="col-6 d-grid p-1">
...
const apiEndpoint_presign =
  'https://828299ds42.execute-api.ap-northeast-2.amazonaws.com/MyWebApp-APIstage/presign';
...
export default {
  ...
  created() {
    ...
    if (!this.getEstimateUpdate.image_urls) {
      this.getEstimateUpdate.image_urls = [];
    }
  },
  methods: {
    ...
    async handleFileUpload(event) {
      ...
      for (const file of files) {
        try {
          ...
          this.getEstimateUpdate.image_urls.push(file_url);
        } catch (err) {
    ...
    // ✅ 이미지 삭제
    removeImage(index) {
      this.getEstimateUpdate.image_urls.splice(index, 1);
    },
